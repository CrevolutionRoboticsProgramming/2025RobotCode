 ...
 */
    public enum State {
        ...
        kScoreL4LeftWrist(Rotation2d.fromRotations(-0.166259765625 - 0.25)),
        kScoreL4RightWrist(Rotation2d.fromRotations(-0.166259765625 + 0.25)),
        kScoreL4Mid(Rotation2d.fromRotations(-0.166259765625)),
