 ...
 */
    public enum State {
        ...
        kGroundLeft(Rotation2d.fromRotations(0.056884765625 - 0.25)),
        kGroundRight(Rotation2d.fromRotations(0.056884765625 + 0.25)),
        kGroundMid(Rotation2d.fromRotations(0.056884765625)),
